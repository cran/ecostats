...
![plot of chunk code15.3](code15.3-1.png)
...
![plot of chunk code15.3beta](code15.3beta-1.png)
...
![plot of chunk code15.4](code15.4-1.png)
...
![plot of chunk code15.4beta](code15.4beta-1.png)
...
![plot of chunk code15.5](code15.5-1.png)
...
![plot of chunk code15.6](code15.6-1.png)
...
![plot of chunk code15.6](code15.6-2.png)
...
#> Warning in fitTMB(TMBStruc): Model convergence problem; false convergence (8). See
#> vignette('troubleshooting')
summary(spid_glmm)
#>  Family: nbinom2  ( log )
