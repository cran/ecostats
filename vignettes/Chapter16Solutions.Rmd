...
#> iter  10 value 822.222854
#> iter  20 value 818.604712
#> iter  30 value 817.369372
#> iter  40 value 791.004057
#> iter  50 value 780.045741
#> iter  60 value 777.960056
#> final  value 777.933447 
#> converged
#>              soil.dry   bare.sand fallen.leaves       moss herb.layer reflection
#> Archetype1  1.5627522 -0.05457262    -0.2776585 -0.1443984  0.7081403 -0.4725645
#> Archetype2 -0.1072806  0.22383732    -0.2858613  0.4185213  0.5891489  0.4757195
```
...
![plot of chunk code16.2](code16.2-1.png)
...
![plot of chunk code16.4](code16.4-1.png)

```r
coefplot(ft_trait)
```

![plot of chunk code16.4](code16.4-2.png)
...
![plot of chunk ex16.5](ex16.5-1.png)

```r
coefplot(ft_anttrait)
```

![plot of chunk ex16.5](ex16.5-2.png)
...
![plot of chunk code16.5](code16.5-1.png)
