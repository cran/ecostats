...
```{r box52, fig.height=6, fig.width=8}
library(DAAG)
...
I used `nSim=1000` in the book, but have set it to `100` here so the code doesn't take ages to run...

_This code chunk has not been evaluated to save on vignette compilation time._

```{r subset sim, fig.width=8, eval=FALSE}
library(mvtnorm)
