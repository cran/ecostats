...
```{r ex10.5, fig.width=8, warning=FALSE, eval=FALSE}
data(windFarms)
eels = windFarms$abund[,16]
...
The Poisson model fans out more and has a couple of residuals that are unusually large (see normal quantile plot).
