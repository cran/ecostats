...
```{r ravens check, fig.width=4, fig.height=4}
 library(ecostats)
 data(ravens)
...
```{r ravens block assumptions, fig.width=8, fig.height=4}
...
```{r seaweed plt, fig.width=8, fig.height=4}
par(mfrow=c(1,2),mar=c(3,3,1,1),mgp=c(1.75,0.75,0))
...
```{r seaweed compBox, fig.width=4, fig.height=4}
...
```{r seaweed fact, fig.width=8, fig.height=4}
 par(mfrow=c(1,2),mar=c(3,3,1,1),mgp=c(1.75,0.75,0))
...
```{r seaweed interplot, fig.width=5, fig.height=4}
 library(dplyr)
...
```{r seaweed interplot2, fig.width=5, fig.height=4}
...
```{r aphid netting, fig.width=4, fig.height=4}
data(aphidsBACI)
str(aphidsBACI)
...
```{r aphid lm, fig.width=8, fig.height=4}
...
```{r seaweed 3, fig.width=6, fig.height=4}
data(seaweed)
str(seaweed)
seaweed$logTot = log(seaweed$Total)
seaweed$Dist = factor(seaweed$Dist)
...
```{r seaweed anova3, fig.width=8, fig.height=4}
 par(mfrow=c(1,3),mar=c(3,3,1,1),mgp=c(1.75,0.75,0))
